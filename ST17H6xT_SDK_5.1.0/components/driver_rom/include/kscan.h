...
/*******************************************************************************
    ...
    @author   Ding
*******************************************************************************/
#ifndef __KSCAN__ROM_H__
#define __KSCAN__ROM_H__
...
#define KSCAN_ALL_ROW_NUM 10
#define KSCAN_ALL_COL_NUM 11

const static uint8_t KSCAN_ROW_GPIO[KSCAN_ALL_ROW_NUM] =
{
	P0,
	P2,
	P7,
...
const static uint8_t KSCAN_COL_GPIO[KSCAN_ALL_COL_NUM] =
{
	P1,
	P3,
	P16,
